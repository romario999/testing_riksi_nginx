...
import { AdminAddBannerImage } from "@/app/actions";
...
export default function AdminWebsiteBannerAddPage() {
    ...
    const handleAddData = async () => {
        try {
            ...
            await AdminAddBannerImage(data);
            toast.success('Банер успішно додано');
            ...
            console.log(error);
            toast.error('Помилка при додаванні банеру');
